<%-- 
    ...
    Created on : Jun 3, 2022, 12:55:28 PM
    Author     : LENOVO
--%>
            ...
            <div class="leaderboard">
                ...
                <ol>
                    <c:forEach items="${requestScope.userList}" var="user">
                        <li class="row">
                            <div id="row_index" class="column"  >${user.row_index}</div>
                            <div id="username" class="column" >${user.name}</div>
                            <div id="exp" class="column"  >${user.exp}</div>
                        </li>
                    </c:forEach>
                </ol>
            </div>

            <div id ="containerbot" class ="pagger" style="padding-top: 50px"></div>
            <script>
                pagger("containerbot",${requestScope.pageindex},${requestScope.totalpage}, 2);
            </script>
        </div>
